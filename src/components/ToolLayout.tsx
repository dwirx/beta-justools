...
export const ToolLayout = ({ toolName, toolIcon, toolDescription, children }: ToolLayoutProps) => {
  return (
    <div className="min-h-screen bg-background safe-top safe-bottom">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="flex items-center gap-3 sm:gap-4 mb-2 sm:mb-4">
              <span className="text-3xl sm:text-5xl">{toolIcon}</span>
              <div className="min-w-0">
                <h1 className="text-xl sm:text-3xl font-bold truncate">{toolName}</h1>
                <p className="text-xs sm:text-base text-muted-foreground line-clamp-2">{toolDescription}</p>
              </div>
            </div>
          </motion.div>
      ...
      <footer className="border-t border-border/50 py-4 sm:py-6 px-4 sm:px-6 mt-auto">
